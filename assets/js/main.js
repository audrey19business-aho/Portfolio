...
(() => {
  ...
  // Inject the freelance CTA into the mobile menu (visible only when open)
  const navList = nav?.querySelector('.nav__list');
  if (navList && !navList.querySelector('.nav__list-cta')) {
    const li = document.createElement('li');
    li.className = 'nav__list-cta';
    li.innerHTML = `<a href="https://www.linkedin.com/" target="_blank" rel="noopener">
      Hire me for a freelance job
